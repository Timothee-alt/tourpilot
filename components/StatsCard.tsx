                    ...
                    <div className="flex items-center gap-2">
                        <figure className="flex items-center gap-1">
                            <img
                                ...
                                alt="arrow"
                            />
                            <figcaption className={cn('text-small font-medium', isDecrement ? 'text-red-500' : 'text-success-500')}>
                                {Math.round(percentage)}%
                            </figcaption>
                        </figure>
                        <p className="text-sm font-medium text-gray-100 truncate">par rapport au mois dernier</p>
                    </div>
                </div>
                <img
