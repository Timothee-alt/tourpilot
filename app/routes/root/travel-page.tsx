    ...
    return (
        <main className="flex flex-col">
                    ...
                    <section className="wrapper">
                        <article>
                            <h1 className="p-72-bold text-dark-100">
                                Planifier facilement vos voyages
                            </h1>

                            <p className="text-dark-100">
                                Customiser votre voyage en quelques minutes, en fonction de vos préférences
                            </p>
                        </article>
            ...
            <section className="pt-20 wrapper flex flex-col gap-10 h-full">
                <Header title="Nos destinations phares" description="Consulter les meilleurs endroits à visiter" />
            ...
            <section id="trips" className="py-20 wrapper flex flex-col gap-10">
                <Header title="Voyages choisis avec soin" description="Parcourez des voyages soigneusement organisés, adaptés à votre façon de voyager." />
